...
def test():
    db.load("template.xlsx") # 加载数据
    pf = PumpFit1.PumpFitting()
    print(len(db.main_fittings))
    B = pf.fit_P1(db.main_fittings)
    mape, rmse = pf.calc_pre_p1()
    print("B: ",B)
    print ("mape: ", mape," rmse: ",rmse)
    A = pf.fit_P2(db.pump2_fittings)
    mape, rmse =pf.calc_pre_p2()
    print("A: ",A)
    print ("mape: ", mape, " rmse: ", rmse)
    C = pf.fit_P3(db.pump3_fittings)
    mape, rmse = pf.calc_pre_p3()
    print("C: ",C)
    print ("mape: ", mape, " rmse: ", rmse)
    web_data_1to1 = db.wet_bulb_fittings_1to1
    web_data_2to1 = db.wet_bulb_fittings_2to1
    web_data_3to1 = db.wet_bulb_fittings_3to1
    web_data_4to1 = db.wet_bulb_fittings_4to1
    web_data_3to2 = db.wet_bulb_fittings_3to2
    web_data_4to3 = db.wet_bulb_fittings_4to3
    ...
    print("E: ",E)
    print ("mape: ", mape, " rmse: ", rmse)
    optimizeCalculate(pf)

def optimizeCalculate(fitResult):
